...
class Order extends CommonModels
{
    ...
    public function scenarios()
    {
        ...
        $scenarios['create'] = ['order_sn', 'status', 'type', 'UID', 'total_amount', 'task_amount', 'pay_amount', 'goods_amount', 'coupon_reduced','promoter_reduced', 'freight_amount', 'merchant_id', 'cancel_time', 'source', 'AppID', 'score_amount', 'total_score'];
