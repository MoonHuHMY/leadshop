...
class OrderController extends BasicController
{
    ...
    {
        // $this->module->event->pay_order_sn = 'osn609291396161909';
        // $this->module->event->pay_uid      = 88;
        // $this->module->trigger('pay_order_test');

        // $this->module->event->refunded = [
        //     "order_sn"       => 'osn609291396161909',
        //     "order_goods_id" => 1224,
        //     "return_number"  => 1,
        // ];
        // $this->module->trigger('refunded_test');

        // $this->module->event->set_level['UID']     = [73];
        // $this->module->event->set_level['type']     = 2;
        // $this->module->trigger('set_level');
